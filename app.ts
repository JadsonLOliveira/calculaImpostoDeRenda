...
class Usuario {
    constructor(nome: string, vl_SalarioBruto: number, vl_TotalDeHorasExtra: number) {
        this.setNome(nome);
    ...
    setVl_SalarioBruto(vl_SalarioBruto: number): void {
    ...
    setVl_salarioLiquido(): void {
        let salarioBruto = this.dadosUsuario.vl_SalarioBruto,
            descontoIr = this.dadosUsuario.vl_DescontadoIr,
            vl_DescontoInss = this.dadosUsuario.vl_DescontoInss,
            vl_HorasExtras = this.dadosUsuario.vl_TotalDeHorasExtra;

        this.dadosUsuario.vl_salarioLiquido = (salarioBruto - descontoIr - vl_DescontoInss) + vl_HorasExtras
    }

    getDadoUsuario(): DadosUsuario {
        return this.dadosUsuario;
    }
}

function processo(nome: string, vl_SalarioBruto: number, vl_TotalDeHorasExtra: number): void {
